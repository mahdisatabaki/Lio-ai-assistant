...
const CLARIFY_GENERAL =
  "یه کم دقیق‌تر بگو دنبال چی هستی تا درست راهنماییت کنم. اسم سرویس یا کاری که می‌خوای انجام بدی کافیه.";

const ASK_FOR_ERROR_TEXT =
  "برای اینکه حدس نزنم، متن خطا یا چند خط آخر خروجی deploy رو بفرست. با همون شروع می‌کنیم.";
